...
const Home: NextPage = () => {
    return (
        <TextContainer>
            ...
            <h2>Contact me</h2>
            <p>Feel free to contact me if you need anything, want to discuss something, or just want to talk. The preffered way would be through the <Link href="https://matrix.to/#/@vfosnar:fosny.eu">Matrix</Link>, but I also have an <Link href="mailto:vfosnar@fosny.eu">E-mail</Link>.</p>
            <h2>More about me</h2>
