...
const Home: NextPage = () => {
    return (
        <TextContainer>
            ...
            <h2>Contact me</h2>
            <p>Feel free to contact me if you need anything, want to discuss something, or just want to talk. The preferred way to contact me would be through the <Link href="https://matrix.to/#/@vfosnar:fosny.eu">Matrix</Link>, but I also have an <Link href="mailto:vfosnar@fosny.eu">E-mail address</Link> that you can use. You can also follow me on <Link href="https://c.im/@vfosnar" passHref={true}><a rel="me">Mastodon</a></Link>.</p>
            <h2>More about me</h2>
